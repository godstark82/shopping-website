      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex mt-1">
            <input onChange={onChangePin}
                ...
                className="border-2 border-gray-300 rounded py-2 px-4 mr-2 focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500"
            />
            <button onClick={checkAvailability} className="bg-indigo-500 text-white py-2 px-4 rounded hover:bg-indigo-600">
                Check
            </button>
